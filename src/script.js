...
fontLoader.load('/fonts/helvetiker_regular.typeface.json', (font)=>{
    ...
    const geometry = new TextGeometry('The Matrix Labs',{
        font:font,
        size:0.5,
        height:0.2,
        curveSegments:5,
...
console.time('donut')
const donutGeomertry = new THREE.TorusGeometry(0.3, 0.2, 20 ,45);
const donutMaterial = new THREE.MeshMatcapMaterial({matcap:matcapTexture});

for(let i=0; i<100; i++){
    const donut = new THREE.Mesh(donutGeomertry, donutMaterial);
